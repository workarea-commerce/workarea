...
Gem::Specification.new do |s|
  ...
  s.add_dependency 'image_optim', '~> 0.27.0'
  s.add_dependency 'image_optim_pack', '~> 0.6.0'
  s.add_dependency 'faker', '~> 2.13.0'
  ...
  s.add_dependency 'i18n-js', '~> 3.7.0'
