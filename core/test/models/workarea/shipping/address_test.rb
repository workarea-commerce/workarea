  ...
  class Shipping
    class AddressTest < TestCase
      def test_po_box_addresses
        ...
        Workarea.config.allow_shipping_address_po_box = false
        ...
        Workarea.config.allow_shipping_address_po_box = true
      ...
      def test_knows_about_the_addressable_it_is_embedded_in
        ...
        assert_equal(shipping, shipping.address.addressable)
      end
    end
  end
end
