...
module Workarea
  module Reports
    class SearchesOverTimeTest < TestCase
      def test_by_day
        ...
        report = SearchesOverTime.new(group_by: 'day', sort_by: '_id', sort_direction: 'desc')
        ...
        report = SearchesOverTime.new(group_by: 'day', sort_by: '_id', sort_direction: 'asc')
        assert_equal(3, report.results.length)
