...
WORKAREA.registerModule('messages', (function () {
    ...
    var createMessage = JST['workarea/admin/templates/message'],
         ...
         * already. Checks the list that we have saved in memory as well
         * as the DOM.
         *
        ...
        removePageMessages = function () {
            $('.page-messages .message').each(function (index, message) {
    ...
    $(document).on('turbolinks:before-cache', removePageMessages);
