  ...
  <div class="wysiwyg__toolbar" id="<%= id %>">
      <div class='wysiwyg__toolbar-dropdown'>
        <button type='button' class='wysiwyg__toolbar-dropdown-button'>
          ...
          #{ inline_svg('workarea/admin/icons/expand_more.svg', class: 'svg-icon svg-icon--small', title: I18n.t('workarea.admin.js.wysiwyg.italic')) }
        </button>
      ...
      <a class='wysiwyg__toolbar-button' data-wysihtml-command='italic'>
        #{ inline_svg('workarea/admin/icons/wysiwyg/italic.svg', class: 'wysiwyg__toolbar-button-icon svg-icon', title: I18n.t('workarea.admin.js.wysiwyg.italic')) }
      </a>
      <a class='wysiwyg__toolbar-button' data-wysihtml-command='underline'>
        #{ inline_svg('workarea/admin/icons/wysiwyg/underline.svg', class: 'wysiwyg__toolbar-button-icon svg-icon', title: I18n.t('workarea.admin.js.wysiwyg.underline')) }
      </a>

      <a class='wysiwyg__toolbar-button' data-wysihtml-command='insertUnorderedList'>
        #{ inline_svg('workarea/admin/icons/wysiwyg/bulleted_list.svg', class: 'wysiwyg__toolbar-button-icon svg-icon', title: I18n.t('workarea.admin.js.wysiwyg.bulleted_list')) }
      </a>
      <a class='wysiwyg__toolbar-button' data-wysihtml-command='insertOrderedList'>
        #{ inline_svg('workarea/admin/icons/wysiwyg/numbered_list.svg', class: 'wysiwyg__toolbar-button-icon svg-icon', title: I18n.t('workarea.admin.js.wysiwyg.numbered_list')) }
      </a>

      <a class='wysiwyg__toolbar-button' data-wysihtml-action='change_view'>
        #{ inline_svg('workarea/admin/icons/wysiwyg/html.svg', class: 'wysiwyg__toolbar-button-icon svg-icon', title: I18n.t('workarea.admin.js.wysiwyg.html')) }
      </a>
      <a class='wysiwyg__toolbar-button' data-wysihtml-command='createLink'>
        #{ inline_svg('workarea/admin/icons/wysiwyg/link.svg', class: 'wysiwyg__toolbar-button-icon svg-icon', title: I18n.t('workarea.admin.js.wysiwyg.insert_link')) }
      </a>
